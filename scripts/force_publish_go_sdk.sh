...
# This script forces the publication of the Go SDK to pkg.go.dev
# It creates a temporary directory with the correct module structure
# and pushes it to a temporary branch
