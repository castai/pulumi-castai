...
type ServiceAccount struct {
	...
	Authors organization.ServiceAccountAuthorArrayOutput `pulumi:"authors"`
...
func NewServiceAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("castai:organization:ServiceAccount", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceAccount(ctx *pulumi.Context,
	...
	var resource ServiceAccount
	err := ctx.ReadResource("castai:organization:ServiceAccount", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type serviceAccountState struct {
	// Author of the service account.
	Authors []organization.ServiceAccountAuthor `pulumi:"authors"`
	// Description of the service account.
...
type ServiceAccountState struct {
	// Author of the service account.
	Authors organization.ServiceAccountAuthorArrayInput
	// Description of the service account.
...
// Author of the service account.
func (o ServiceAccountOutput) Authors() organization.ServiceAccountAuthorArrayOutput {
	return o.ApplyT(func(v *ServiceAccount) organization.ServiceAccountAuthorArrayOutput { return v.Authors }).(organization.ServiceAccountAuthorArrayOutput)
}
