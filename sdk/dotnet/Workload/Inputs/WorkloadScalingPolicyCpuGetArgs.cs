...
namespace Pulumi.CastAI.Workload.Inputs
{
    ...
    public sealed class WorkloadScalingPolicyCpuGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WorkloadScalingPolicyCpuApplyThresholdStrategyGetArgs>? ApplyThresholdStrategy { get; set; }
        ...
        /// </summary>
        [Input("limit")]
        public Input<Inputs.WorkloadScalingPolicyCpuLimitGetArgs>? Limit { get; set; }
        ...
        public WorkloadScalingPolicyCpuGetArgs()
        {
        }
        public static new WorkloadScalingPolicyCpuGetArgs Empty => new WorkloadScalingPolicyCpuGetArgs();
    }
}
