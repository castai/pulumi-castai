...
namespace Pulumi.CastAI.Workload.Inputs
{
    ...
    public sealed class WorkloadScalingPolicyCpuArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WorkloadScalingPolicyCpuApplyThresholdStrategyArgs>? ApplyThresholdStrategy { get; set; }
        ...
        /// </summary>
        [Input("limit")]
        public Input<Inputs.WorkloadScalingPolicyCpuLimitArgs>? Limit { get; set; }
        ...
        public WorkloadScalingPolicyCpuArgs()
        {
        }
        public static new WorkloadScalingPolicyCpuArgs Empty => new WorkloadScalingPolicyCpuArgs();
    }
}
