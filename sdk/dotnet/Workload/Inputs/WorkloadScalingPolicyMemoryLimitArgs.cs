...
namespace Pulumi.CastAI.Workload.Inputs
{
    ...
    public sealed class WorkloadScalingPolicyMemoryLimitArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public WorkloadScalingPolicyMemoryLimitArgs()
        {
        }
        public static new WorkloadScalingPolicyMemoryLimitArgs Empty => new WorkloadScalingPolicyMemoryLimitArgs();
    }
}
