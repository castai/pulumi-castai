...
namespace Pulumi.CastAI.Workload.Inputs
{
    ...
    public sealed class WorkloadScalingPolicyMemoryGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WorkloadScalingPolicyMemoryApplyThresholdStrategyGetArgs>? ApplyThresholdStrategy { get; set; }
        ...
        /// </summary>
        [Input("limit")]
        public Input<Inputs.WorkloadScalingPolicyMemoryLimitGetArgs>? Limit { get; set; }
        ...
        public WorkloadScalingPolicyMemoryGetArgs()
        {
        }
        public static new WorkloadScalingPolicyMemoryGetArgs Empty => new WorkloadScalingPolicyMemoryGetArgs();
    }
}
