...
namespace Pulumi.CastAI
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/castai";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.CastAI.version.txt");
    ...
    internal sealed class CastAIResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CastAIResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
