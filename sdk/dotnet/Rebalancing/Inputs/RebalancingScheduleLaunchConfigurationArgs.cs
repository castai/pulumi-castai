...
namespace Pulumi.CastAI.Rebalancing.Inputs
{
    ...
    public sealed class RebalancingScheduleLaunchConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.RebalancingScheduleLaunchConfigurationAggressiveModeConfigArgs>? AggressiveModeConfig { get; set; }

        [Input("executionConditions")]
        public Input<Inputs.RebalancingScheduleLaunchConfigurationExecutionConditionsArgs>? ExecutionConditions { get; set; }
        ...
        public RebalancingScheduleLaunchConfigurationArgs()
        {
        }
        public static new RebalancingScheduleLaunchConfigurationArgs Empty => new RebalancingScheduleLaunchConfigurationArgs();
    }
}
