...
namespace Pulumi.CastAI.Rebalancing.Outputs
{
    ...
    [OutputType]
    public sealed class GetHibernationScheduleDataSourceResumeConfigScheduleResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetHibernationScheduleDataSourceResumeConfigScheduleResult(string cronExpression)
        {
