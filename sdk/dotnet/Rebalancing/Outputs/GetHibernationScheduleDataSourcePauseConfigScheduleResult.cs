...
namespace Pulumi.CastAI.Rebalancing.Outputs
{
    ...
    [OutputType]
    public sealed class GetHibernationScheduleDataSourcePauseConfigScheduleResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetHibernationScheduleDataSourcePauseConfigScheduleResult(string cronExpression)
        {
