...
namespace Pulumi.CastAI.Rebalancing.Outputs
{
    ...
    [OutputType]
    public sealed class GetHibernationScheduleDataSourceResumeConfigJobConfigNodeConfigVolumeRaidConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetHibernationScheduleDataSourceResumeConfigJobConfigNodeConfigVolumeRaidConfigResult(int? chunkSizeKb)
        {
