...
export declare class Reservations extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReservationsState, opts?: pulumi.CustomResourceOptions): Reservations;
    /**
     * Returns true if the given object is an instance of Reservations.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Reservations;
    /**
     * organization
     */
    readonly organizationId: pulumi.Output<string | undefined>;
    readonly reservations: pulumi.Output<outputs.ReservationsReservation[]>;
    /**
     * csv file containing reservations
     */
    readonly reservationsCsv: pulumi.Output<string>;
    /**
