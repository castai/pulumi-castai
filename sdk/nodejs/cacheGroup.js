...
class CacheGroup extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new CacheGroup(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'castai:cache:CacheGroup';
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === CacheGroup.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        super(CacheGroup.__pulumiType, name, resourceInputs, opts);
    }
}
exports.CacheGroup = CacheGroup;
//# sourceMappingURL=cacheGroup.js.map