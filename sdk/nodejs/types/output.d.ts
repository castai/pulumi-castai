...
export interface AiOptimizerHostedModelHibernation {
    enabled?: boolean;
    hibernateCondition: outputs.AiOptimizerHostedModelHibernationHibernateCondition;
    resumeCondition: outputs.AiOptimizerHostedModelHibernationResumeCondition;
}
...
export interface PodMutationAffinity {
    nodeAffinity?: outputs.PodMutationAffinityNodeAffinity;
}
export interface PodMutationAffinityNodeAffinity {
    preferredDuringSchedulingIgnoredDuringExecutions?: outputs.PodMutationAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution[];
}
...
export interface PodMutationAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference {
    matchExpressions?: outputs.PodMutationAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpression[];
}
...
export interface PodMutationDistributionGroupConfiguration {
     ...
     */
    affinity?: outputs.PodMutationDistributionGroupConfigurationAffinity;
    /**
     ...
     */
    nodeSelector?: outputs.PodMutationDistributionGroupConfigurationNodeSelector;
    /**
     ...
     */
    tolerations?: outputs.PodMutationDistributionGroupConfigurationToleration[];
}
export interface PodMutationDistributionGroupConfigurationAffinity {
    nodeAffinity?: outputs.PodMutationDistributionGroupConfigurationAffinityNodeAffinity;
}
export interface PodMutationDistributionGroupConfigurationAffinityNodeAffinity {
    preferredDuringSchedulingIgnoredDuringExecutions?: outputs.PodMutationDistributionGroupConfigurationAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution[];
}
...
export interface PodMutationDistributionGroupConfigurationAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference {
    matchExpressions?: outputs.PodMutationDistributionGroupConfigurationAffinityNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpression[];
}
...
export interface PodMutationFilterV2 {
     ...
     */
    pod?: outputs.PodMutationFilterV2Pod;
    /**
     * Workload filter for kinds, names, and namespaces.
     */
    workload?: outputs.PodMutationFilterV2Workload;
}
export interface PodMutationFilterV2Pod {
    excludeLabelsFilter?: outputs.PodMutationFilterV2PodExcludeLabelsFilter;
    labelsFilter?: outputs.PodMutationFilterV2PodLabelsFilter;
    /**
     * Tolerations filter for matching pods by their tolerations.
     */
    tolerationsFilter?: outputs.PodMutationFilterV2PodTolerationsFilter;
}
export interface PodMutationFilterV2PodExcludeLabelsFilter {
    matchers: outputs.PodMutationFilterV2PodExcludeLabelsFilterMatcher[];
    /**
...
export interface PodMutationFilterV2PodExcludeLabelsFilterMatcher {
    ...
    value?: outputs.PodMutationFilterV2PodExcludeLabelsFilterMatcherValue;
}
...
export interface PodMutationFilterV2PodLabelsFilter {
    matchers: outputs.PodMutationFilterV2PodLabelsFilterMatcher[];
    /**
     * Logical operator to combine label matchers: AND or OR.
     */
    operator: string;
...
export interface PodMutationFilterV2PodLabelsFilterMatcher {
    ...
    value?: outputs.PodMutationFilterV2PodLabelsFilterMatcherValue;
}
...
export interface PodMutationFilterV2PodTolerationsFilter {
    matchers: outputs.PodMutationFilterV2PodTolerationsFilterMatcher[];
    /**
...
export interface PodMutationFilterV2PodTolerationsFilterMatcher {
    ...
    operator?: outputs.PodMutationFilterV2PodTolerationsFilterMatcherOperator;
    value?: outputs.PodMutationFilterV2PodTolerationsFilterMatcherValue;
}
...
export interface PodMutationFilterV2Workload {
    excludeKinds?: outputs.PodMutationFilterV2WorkloadExcludeKind[];
    excludeNames?: outputs.PodMutationFilterV2WorkloadExcludeName[];
    excludeNamespaces?: outputs.PodMutationFilterV2WorkloadExcludeNamespace[];
    kinds?: outputs.PodMutationFilterV2WorkloadKind[];
    names?: outputs.PodMutationFilterV2WorkloadName[];
    namespaces?: outputs.PodMutationFilterV2WorkloadNamespace[];
}
...
export declare namespace cache {
    ...
    interface GetCacheGroupEndpoint {
        /**
...
export declare namespace config {
    ...
    interface NodeConfigurationEks {
         ...
         */
        enaQueueCountPerInterface?: number;
        /**
    ...
    interface NodeTemplateConstraints {
         ...
         */
        aws?: outputs.config.NodeTemplateConstraintsAws;
        /**
         ...
         */
        gcp?: outputs.config.NodeTemplateConstraintsGcp;
...
export declare namespace rebalancing {
    interface GetHibernationScheduleClusterAssignment {
        assignments?: outputs.rebalancing.GetHibernationScheduleClusterAssignmentAssignment[];
    }
    ...
    interface GetHibernationSchedulePauseConfig {
        /**
         * Enables or disables the pause configuration.
         */
        enabled: boolean;
        schedule: outputs.rebalancing.GetHibernationSchedulePauseConfigSchedule;
    }
    interface GetHibernationSchedulePauseConfigSchedule {
        /**
    ...
    interface GetHibernationScheduleResumeConfig {
        /**
         * Enables or disables the pause configuration.
         */
        enabled: boolean;
        jobConfig: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfig;
        schedule: outputs.rebalancing.GetHibernationScheduleResumeConfigSchedule;
    }
    interface GetHibernationScheduleResumeConfigJobConfig {
        nodeConfig: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfigNodeConfig;
    }
    interface GetHibernationScheduleResumeConfigJobConfigNodeConfig {
        /**
         ...
         */
        configName?: string;
        gpuConfig?: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfigNodeConfigGpuConfig;
        /**
         * Instance type.
         */
        instanceType: string;
         ...
         */
        kubernetesTaints?: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfigNodeConfigKubernetesTaint[];
        /**
         * Custom taints to be added to the node created from this configuration.
         */
        nodeAffinities?: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfigNodeConfigNodeAffinity[];
        /**
         * Custom taints to be added to the node created from this configuration.
         */
        spotConfigs?: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfigNodeConfigSpotConfig[];
        /**
         * Node subnet ID.
         */
        subnetId?: string;
        volumes?: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfigNodeConfigVolume[];
        /**
         * Zone of the node.
         */
        zone?: string;
    }
    interface GetHibernationScheduleResumeConfigJobConfigNodeConfigGpuConfig {
        /**
         * Number of GPUs.
         */
        count: number;
    ...
    interface GetHibernationScheduleResumeConfigJobConfigNodeConfigKubernetesTaint {
        /**
         * Effect of a taint to be added to nodes created from this template, the default is NoSchedule. Allowed values: NoSchedule, NoExecute.
         */
        effect?: string;
    ...
    interface GetHibernationScheduleResumeConfigJobConfigNodeConfigNodeAffinity {
        affinities?: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfigNodeConfigNodeAffinityAffinity[];
        /**
         * Key of a taint to be added to nodes created from this template.
         */
        dedicatedGroup: string;
    }
    interface GetHibernationScheduleResumeConfigJobConfigNodeConfigNodeAffinityAffinity {
        /**
         * Key of the node affinity selector.
         */
        key: string;
    ...
    interface GetHibernationScheduleResumeConfigJobConfigNodeConfigSpotConfig {
        /**
    ...
    interface GetHibernationScheduleResumeConfigJobConfigNodeConfigVolume {
        raidConfigs?: outputs.rebalancing.GetHibernationScheduleResumeConfigJobConfigNodeConfigVolumeRaidConfig[];
        /**
         * Volume size in GiB.
         */
        sizeGib?: number;
    }
    interface GetHibernationScheduleResumeConfigJobConfigNodeConfigVolumeRaidConfig {
        /**
    ...
    interface GetHibernationScheduleResumeConfigSchedule {
        /**
         * Cron expression defining when the schedule should trigger.
         *
         *   The `cron` expression can optionally include the `CRON_TZ` variable at the beginning to specify the timezone in which the schedule should be interpreted.
    ...
    interface GetRebalancingScheduleLaunchConfiguration {
        /**
         ...
         */
        aggressiveModeConfig?: outputs.rebalancing.GetRebalancingScheduleLaunchConfigurationAggressiveModeConfig;
        /**
         * Configures behavior when a node fails to drain during rebalancing. Relevant only when `keepDrainTimeoutNodes` is true.
         */
        drainFailureConfig?: outputs.rebalancing.GetRebalancingScheduleLaunchConfigurationDrainFailureConfig;
        executionConditions?: outputs.rebalancing.GetRebalancingScheduleLaunchConfigurationExecutionConditions;
        /**
    ...
    interface GetRebalancingScheduleLaunchConfigurationAggressiveModeConfig {
        /**
    ...
    interface GetRebalancingScheduleLaunchConfigurationDrainFailureConfig {
        /**
    ...
    interface GetRebalancingScheduleLaunchConfigurationExecutionConditions {
        /**
    ...
    interface GetRebalancingScheduleSchedule {
        /**
         * Cron expression defining when the schedule should trigger.
         *
         *   The `cron` expression can optionally include the `CRON_TZ` variable at the beginning to specify the timezone in which the schedule should be interpreted.
    ...
    interface GetRebalancingScheduleTriggerCondition {
        /**
    ...
    interface RebalancingScheduleLaunchConfiguration {
         ...
         * Configures behavior when a node fails to drain during rebalancing. Relevant only when `keepDrainTimeoutNodes` is true.
         */
        drainFailureConfig?: outputs.rebalancing.RebalancingScheduleLaunchConfigurationDrainFailureConfig;
...
export declare namespace workload {
    interface GetWorkloadScalingPoliciesPolicy {
        /**
         * Policy UUID.
         */
        id: string;
    ...
    interface WorkloadCustomMetricsDataSourcePrometheus {
         ...
         */
        metrics?: outputs.workload.WorkloadCustomMetricsDataSourcePrometheusMetric[];
        /**
    ...
    interface WorkloadScalingPolicyAnomalyDetection {
         ...
         */
        cpuPressure?: outputs.workload.WorkloadScalingPolicyAnomalyDetectionCpuPressure;
    }
    ...
    interface WorkloadScalingPolicyAssignmentRuleRuleNamespace {
         ...
         */
        labelsExpressions?: outputs.workload.WorkloadScalingPolicyAssignmentRuleRuleNamespaceLabelsExpression[];
        /**
    ...
    interface WorkloadScalingPolicyCpu {
         ...
         */
        constraints?: outputs.workload.WorkloadScalingPolicyCpuConstraints;
        /**
    ...
    interface WorkloadScalingPolicyCpuConstraints {
        max?: outputs.workload.WorkloadScalingPolicyCpuConstraintsMax;
        min?: outputs.workload.WorkloadScalingPolicyCpuConstraintsMin;
    }
    ...
    interface WorkloadScalingPolicyJvm {
         ...
         */
        memory?: outputs.workload.WorkloadScalingPolicyJvmMemory;
    }
    ...
    interface WorkloadScalingPolicyMemory {
         ...
         * Defines min/max bounds for the recommendation using constraint strategies.
         */
        constraints?: outputs.workload.WorkloadScalingPolicyMemoryConstraints;
        /**
         * The function used to calculate the resource recommendation. Supported values: `QUANTILE`, `MAX`
         */
        function?: string;
    ...
    interface WorkloadScalingPolicyMemoryConstraints {
        max?: outputs.workload.WorkloadScalingPolicyMemoryConstraintsMax;
        min?: outputs.workload.WorkloadScalingPolicyMemoryConstraintsMin;
    }
    ...
    interface WorkloadScalingPolicyStartup {
         ...
         */
        twoPhaseRecommendations?: outputs.workload.WorkloadScalingPolicyStartupTwoPhaseRecommendations;
    }
    interface WorkloadScalingPolicyStartupTwoPhaseRecommendations {
         ...
         */
        requestsOnStartup?: outputs.workload.WorkloadScalingPolicyStartupTwoPhaseRecommendationsRequestsOnStartup;
    }
