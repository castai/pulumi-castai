...
exports.AiOptimizerModelRegistry = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("./utilities"));
class AiOptimizerModelRegistry extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AiOptimizerModelRegistry(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'castai:index/aiOptimizer:AiOptimizerModelRegistry';
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === AiOptimizerModelRegistry.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        super(AiOptimizerModelRegistry.__pulumiType, name, resourceInputs, opts);
    }
}
exports.AiOptimizerModelRegistry = AiOptimizerModelRegistry;
//# sourceMappingURL=aiOptimizerModelRegistry.js.map