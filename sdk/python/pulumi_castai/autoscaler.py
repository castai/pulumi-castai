...
class AutoscalerArgs:
    def __init__(__self__, *,
        ...
        if autoscaler_policies_json is not None:
            warnings.warn("""use autoscaler_settings instead. See README for example: https://github.com/castai/terraform-provider-castai?tab=readme-ov-file#migrating-from-6xx-to-7xx""", DeprecationWarning)
            pulumi.log.warn("""autoscaler_policies_json is deprecated: use autoscaler_settings instead. See README for example: https://github.com/castai/terraform-provider-castai?tab=readme-ov-file#migrating-from-6xx-to-7xx""")
        if autoscaler_policies_json is not None:
            pulumi.set(__self__, "autoscaler_policies_json", autoscaler_policies_json)
        if autoscaler_settings is not None:
            pulumi.set(__self__, "autoscaler_settings", autoscaler_settings)
...
@pulumi.type_token("castai:autoscaling:Autoscaler")
class Autoscaler(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] autoscaler_policies_json: autoscaler policies JSON string to override current autoscaler settings
        :param pulumi.Input[Union['_autoscaling.AutoscalerAutoscalerSettingsArgs', '_autoscaling.AutoscalerAutoscalerSettingsArgsDict']] autoscaler_settings: autoscaler policy definitions to override current autoscaler settings
        :param pulumi.Input[_builtins.str] cluster_id: CAST AI cluster id
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["autoscaler_settings"] = autoscaler_settings
    ...
    @pulumi.getter(name="autoscalerPoliciesJson")
    @_utilities.deprecated("""use autoscaler_settings instead. See README for example: https://github.com/castai/terraform-provider-castai?tab=readme-ov-file#migrating-from-6xx-to-7xx""")
    def autoscaler_policies_json(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        autoscaler policies JSON string to override current autoscaler settings
        """
        return pulumi.get(self, "autoscaler_policies_json")
    ...
    @_builtins.property
    @pulumi.getter(name="autoscalerSettings")
    def autoscaler_settings(self) -> pulumi.Output[Optional['_autoscaling.outputs.AutoscalerAutoscalerSettings']]:
        """
        autoscaler policy definitions to override current autoscaler settings
        """
        return pulumi.get(self, "autoscaler_settings")
