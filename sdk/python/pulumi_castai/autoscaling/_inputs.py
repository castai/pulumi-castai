...
class AutoscalerAutoscalerSettingsArgsDict(TypedDict):
    cluster_limits: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsClusterLimitsArgsDict']]]
    """
    ...
    """
    is_scoped_mode: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    run autoscaler in scoped mode. Only marked pods and nodes will be considered.
    """
    node_downscaler: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerArgsDict']]]
    """
    node downscaler defines policies for removing nodes based on the configured conditions.
    """
    node_templates_partial_matching_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    marks whether partial matching should be used when deciding which custom node template to select.
    """
    spot_instances: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesArgsDict']]]
    """
    policy defining whether autoscaler can use spot instances for provisioning additional workloads.
    """
    unschedulable_pods: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsArgsDict']]]
    """
...
class AutoscalerAutoscalerSettingsArgs:
    def __init__(__self__, *,
                 cluster_limits: pulumi.Input[Optional['AutoscalerAutoscalerSettingsClusterLimitsArgs']] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 is_scoped_mode: pulumi.Input[Optional[_builtins.bool]] = None,
                 node_downscaler: pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerArgs']] = None,
                 node_templates_partial_matching_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 spot_instances: pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesArgs']] = None,
                 unschedulable_pods: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsArgs']] = None):
        """
    ...
    def cluster_limits(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsClusterLimitsArgs']]:
        """
        defines minimum and maximum amount of CPU the cluster can have.
        """
    ...
    def cluster_limits(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsClusterLimitsArgs']]):
    ...
    def is_scoped_mode(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        run autoscaler in scoped mode. Only marked pods and nodes will be considered.
        """
    ...
    def is_scoped_mode(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "is_scoped_mode", value)

    @_builtins.property
    @pulumi.getter(name="nodeDownscaler")
    def node_downscaler(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerArgs']]:
        """
        node downscaler defines policies for removing nodes based on the configured conditions.
        """
    ...
    def node_downscaler(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerArgs']]):
        pulumi.set(self, "node_downscaler", value)

    @_builtins.property
    @pulumi.getter(name="nodeTemplatesPartialMatchingEnabled")
    def node_templates_partial_matching_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        marks whether partial matching should be used when deciding which custom node template to select.
        """
    ...
    def node_templates_partial_matching_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def spot_instances(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesArgs']]:
        """
        policy defining whether autoscaler can use spot instances for provisioning additional workloads.
        """
    ...
    def spot_instances(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesArgs']]):
        pulumi.set(self, "spot_instances", value)

    @_builtins.property
    @pulumi.getter(name="unschedulablePods")
    def unschedulable_pods(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsArgs']]:
        """
        policy defining autoscaler's behavior when unschedulable pods were detected.
        """
    ...
    def unschedulable_pods(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsArgs']]):
        pulumi.set(self, "unschedulable_pods", value)


class AutoscalerAutoscalerSettingsClusterLimitsArgsDict(TypedDict):
    cpu: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsClusterLimitsCpuArgsDict']]]
    """
...
class AutoscalerAutoscalerSettingsClusterLimitsArgs:
    def __init__(__self__, *,
                 cpu: pulumi.Input[Optional['AutoscalerAutoscalerSettingsClusterLimitsCpuArgs']] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def cpu(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsClusterLimitsCpuArgs']]:
        """
        defines the minimum and maximum amount of CPUs for cluster's worker nodes.
        """
    ...
    @cpu.setter
    def cpu(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsClusterLimitsCpuArgs']]):
...
class AutoscalerAutoscalerSettingsClusterLimitsCpuArgsDict(TypedDict):
    ...
    """
    min_cores: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class AutoscalerAutoscalerSettingsClusterLimitsCpuArgs:
    def __init__(__self__, *,
                 ...
                 min_cores: pulumi.Input[Optional[_builtins.int]] = None):
        """
        :param pulumi.Input[_builtins.int] max_cores: defines the maximum allowed amount of vCPUs in the whole cluster.
        :param pulumi.Input[_builtins.int] min_cores: defines the minimum allowed amount of CPUs in the whole cluster. This field is deprecated.
        """
        if max_cores is not None:
            pulumi.set(__self__, "max_cores", max_cores)
        if min_cores is not None:
            warnings.warn("""This field is deprecated and will be removed in a future major version of the provider.""", DeprecationWarning)
            pulumi.log.warn("""min_cores is deprecated: This field is deprecated and will be removed in a future major version of the provider.""")
        if min_cores is not None:
    ...
    def min_cores(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        defines the minimum allowed amount of CPUs in the whole cluster. This field is deprecated.
        """
    ...
    @min_cores.setter
    def min_cores(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "min_cores", value)


class AutoscalerAutoscalerSettingsNodeDownscalerArgsDict(TypedDict):
    empty_nodes: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerEmptyNodesArgsDict']]]
    """
    ...
    """
    evictor: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerEvictorArgsDict']]]
    """
...
class AutoscalerAutoscalerSettingsNodeDownscalerArgs:
    def __init__(__self__, *,
                 empty_nodes: pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerEmptyNodesArgs']] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 evictor: pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerEvictorArgs']] = None):
        """
    ...
    def empty_nodes(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerEmptyNodesArgs']]:
        """
        defines whether Node Downscaler should opt in for removing empty worker nodes when possible.
        """
    ...
    @empty_nodes.setter
    def empty_nodes(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerEmptyNodesArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def evictor(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerEvictorArgs']]:
        """
        defines the CAST AI Evictor component settings. Evictor watches the pods running in your cluster and looks for ways to compact them into fewer nodes, making nodes empty, which will be removed by the empty worker nodes policy.
        """
    ...
    @evictor.setter
    def evictor(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsNodeDownscalerEvictorArgs']]):
...
class AutoscalerAutoscalerSettingsNodeDownscalerEvictorArgsDict(TypedDict):
    ...
    """
    cycle_interval: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    ignore_pod_disruption_budgets: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    if enabled then Evictor will attempt to evict pods that have pod disruption budgets configured.
    """
    node_grace_period_minutes: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    pod_eviction_failure_back_off_interval: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    scoped_mode: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class AutoscalerAutoscalerSettingsNodeDownscalerEvictorArgs:
    def __init__(__self__, *,
                 ...
                 cycle_interval: pulumi.Input[Optional[_builtins.str]] = None,
                 dry_run: pulumi.Input[Optional[_builtins.bool]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 ignore_pod_disruption_budgets: pulumi.Input[Optional[_builtins.bool]] = None,
                 node_grace_period_minutes: pulumi.Input[Optional[_builtins.int]] = None,
                 pod_eviction_failure_back_off_interval: pulumi.Input[Optional[_builtins.str]] = None,
                 scoped_mode: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def cycle_interval(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        configure the interval duration between Evictor operations. This property can be used to lower or raise the frequency of the Evictor's find-and-drain operations.
        """
    ...
    def cycle_interval(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def ignore_pod_disruption_budgets(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        if enabled then Evictor will attempt to evict pods that have pod disruption budgets configured.
        """
    ...
    def ignore_pod_disruption_budgets(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "ignore_pod_disruption_budgets", value)

    @_builtins.property
    @pulumi.getter(name="nodeGracePeriodMinutes")
    def node_grace_period_minutes(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        configure the node grace period which controls the duration which must pass after a node has been created before Evictor starts considering that node.
        """
    ...
    def node_grace_period_minutes(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "node_grace_period_minutes", value)

    @_builtins.property
    @pulumi.getter(name="podEvictionFailureBackOffInterval")
    def pod_eviction_failure_back_off_interval(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        configure the pod eviction failure back off interval. If pod eviction fails then Evictor will attempt to evict it again after the amount of time specified here.
        """
    ...
    def pod_eviction_failure_back_off_interval(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "pod_eviction_failure_back_off_interval", value)

    @_builtins.property
    @pulumi.getter(name="scopedMode")
    def scoped_mode(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        enable/disable scoped mode. By default, Evictor targets all nodes in the cluster. This mode will constrain it to just the nodes which were created by CAST AI.
        """
    ...
    @scoped_mode.setter
    def scoped_mode(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class AutoscalerAutoscalerSettingsSpotInstancesArgsDict(TypedDict):
    ...
    """
    max_reclaim_rate: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    spot_backups: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesSpotBackupsArgsDict']]]
    """
    policy defining whether autoscaler can use spot backups instead of spot instances when spot instances are not available.
    """
    spot_diversity_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    spot_diversity_price_increase_limit: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    spot_interruption_predictions: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesSpotInterruptionPredictionsArgsDict']]]
    """
...
class AutoscalerAutoscalerSettingsSpotInstancesArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 max_reclaim_rate: pulumi.Input[Optional[_builtins.int]] = None,
                 spot_backups: pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesSpotBackupsArgs']] = None,
                 spot_diversity_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 spot_diversity_price_increase_limit: pulumi.Input[Optional[_builtins.int]] = None,
                 spot_interruption_predictions: pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesSpotInterruptionPredictionsArgs']] = None):
        """
    ...
    def max_reclaim_rate(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        max allowed reclaim rate when choosing spot instance type. E.g. if the value is 10%, instance types having 10% or higher reclaim rate will not be considered. Set to zero to use all instance types regardless of reclaim rate.
        """
    ...
    def max_reclaim_rate(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def spot_backups(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesSpotBackupsArgs']]:
        """
        policy defining whether autoscaler can use spot backups instead of spot instances when spot instances are not available.
        """
    ...
    @spot_backups.setter
    def spot_backups(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesSpotBackupsArgs']]):
    ...
    def spot_diversity_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        enable/disable spot diversity policy. When enabled, autoscaler will try to balance between diverse and cost optimal instance types.
        """
    ...
    def spot_diversity_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def spot_diversity_price_increase_limit(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        allowed node configuration price increase when diversifying instance types. E.g. if the value is 10%, then the overall price of diversified instance types can be 10% higher than the price of the optimal configuration.
        """
    ...
    def spot_diversity_price_increase_limit(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def spot_interruption_predictions(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesSpotInterruptionPredictionsArgs']]:
        """
        configure the handling of SPOT interruption predictions.
        """
    ...
    def spot_interruption_predictions(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsSpotInstancesSpotInterruptionPredictionsArgs']]):
...
class AutoscalerAutoscalerSettingsSpotInstancesSpotBackupsArgsDict(TypedDict):
    ...
    """
    spot_backup_restore_rate_seconds: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class AutoscalerAutoscalerSettingsSpotInstancesSpotBackupsArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 spot_backup_restore_rate_seconds: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def spot_backup_restore_rate_seconds(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        defines interval on how often spot backups restore to real spot should occur.
        """
    ...
    def spot_backup_restore_rate_seconds(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class AutoscalerAutoscalerSettingsSpotInstancesSpotInterruptionPredictionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] spot_interruption_predictions_type: define the type of the spot interruption prediction to handle. The value "AWSRebalanceRecommendations" is deprecated; use "CASTAIInterruptionPredictions".
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if spot_interruption_predictions_type is not None:
            warnings.warn("""The value \"AWSRebalanceRecommendations\" is deprecated. Cast AI ML predictions are now used for all spot interruption prediction.""", DeprecationWarning)
            pulumi.log.warn("""spot_interruption_predictions_type is deprecated: The value \"AWSRebalanceRecommendations\" is deprecated. Cast AI ML predictions are now used for all spot interruption prediction.""")
        if spot_interruption_predictions_type is not None:
...
class AutoscalerAutoscalerSettingsUnschedulablePodsArgsDict(TypedDict):
    custom_instances_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    headroom: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomArgsDict']]]
    """
    additional headroom based on cluster's total available capacity for on-demand nodes.
    """
    headroom_spot: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomSpotArgsDict']]]
    """
    additional headroom based on cluster's total available capacity for spot nodes.
    """
    node_constraints: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsNodeConstraintsArgsDict']]]
    """
    defines the node constraints that will be applied when autoscaling with Unschedulable Pods policy.
    """
    pod_pinner: NotRequired[pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsPodPinnerArgsDict']]]
    """
...
class AutoscalerAutoscalerSettingsUnschedulablePodsArgs:
    def __init__(__self__, *,
                 ...
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 headroom: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomArgs']] = None,
                 headroom_spot: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomSpotArgs']] = None,
                 node_constraints: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsNodeConstraintsArgs']] = None,
                 pod_pinner: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsPodPinnerArgs']] = None):
        """
    ...
    def headroom(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomArgs']]:
        """
        additional headroom based on cluster's total available capacity for on-demand nodes.
        """
    ...
    @headroom.setter
    def headroom(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomArgs']]):
    ...
    def headroom_spot(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomSpotArgs']]:
        """
        additional headroom based on cluster's total available capacity for spot nodes.
        """
    ...
    def headroom_spot(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomSpotArgs']]):
    ...
    def node_constraints(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsNodeConstraintsArgs']]:
        """
        defines the node constraints that will be applied when autoscaling with Unschedulable Pods policy.
        """
    ...
    def node_constraints(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsNodeConstraintsArgs']]):
        pulumi.set(self, "node_constraints", value)

    @_builtins.property
    @pulumi.getter(name="podPinner")
    def pod_pinner(self) -> pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsPodPinnerArgs']]:
        """
        defines the Cast AI Pod Pinner components settings.
        """
    ...
    @pod_pinner.setter
    def pod_pinner(self, value: pulumi.Input[Optional['AutoscalerAutoscalerSettingsUnschedulablePodsPodPinnerArgs']]):
        pulumi.set(self, "pod_pinner", value)


class AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomArgsDict(TypedDict):
    cpu_percentage: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    memory_percentage: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class AutoscalerAutoscalerSettingsUnschedulablePodsHeadroomArgs:
    def __init__(__self__, *,
                 cpu_percentage: pulumi.Input[Optional[_builtins.int]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 memory_percentage: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def cpu_percentage(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        defines percentage of additional CPU capacity to be added.
        """
    ...
    def cpu_percentage(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def memory_percentage(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        defines percentage of additional memory capacity to be added.
        """
    ...
    def memory_percentage(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class AutoscalerAutoscalerSettingsUnschedulablePodsNodeConstraintsArgsDict(TypedDict):
    ...
    """
    max_ram_mib: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    min_ram_mib: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class AutoscalerAutoscalerSettingsUnschedulablePodsNodeConstraintsArgs:
    def __init__(__self__, *,
                 ...
                 max_ram_mib: pulumi.Input[Optional[_builtins.int]] = None,
                 min_cpu_cores: pulumi.Input[Optional[_builtins.int]] = None,
                 min_ram_mib: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def max_ram_mib(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        defines max RAM in MiB for the node to pick.
        """
    ...
    @max_ram_mib.setter
    def max_ram_mib(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def min_ram_mib(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        defines min RAM in MiB for the node to pick.
        """
    ...
    @min_ram_mib.setter
    def min_ram_mib(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class EvictorAdvancedConfigEvictorAdvancedConfigArgsDict(TypedDict):
    aggressive: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Apply Aggressive mode to Evictor
    """
    disposable: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Mark node as disposable
    """
    node_selectors: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorArgsDict']]]]]
    """
    node selector
    """
    pod_selectors: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorArgsDict']]]]]
    """
    pod selector
    """
    removal_disabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class EvictorAdvancedConfigEvictorAdvancedConfigArgs:
    def __init__(__self__, *,
                 aggressive: pulumi.Input[Optional[_builtins.bool]] = None,
                 disposable: pulumi.Input[Optional[_builtins.bool]] = None,
                 node_selectors: pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorArgs']]]] = None,
                 pod_selectors: pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorArgs']]]] = None,
                 removal_disabled: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def aggressive(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Apply Aggressive mode to Evictor
        """
    ...
    @aggressive.setter
    def aggressive(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "aggressive", value)

    @_builtins.property
    @pulumi.getter
    def disposable(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Mark node as disposable
        """
    ...
    @disposable.setter
    def disposable(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disposable", value)

    @_builtins.property
    @pulumi.getter(name="nodeSelectors")
    def node_selectors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorArgs']]]]:
        """
        node selector
        """
    ...
    def node_selectors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorArgs']]]]):
        pulumi.set(self, "node_selectors", value)

    @_builtins.property
    @pulumi.getter(name="podSelectors")
    def pod_selectors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorArgs']]]]:
        """
        pod selector
        """
    ...
    def pod_selectors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorArgs']]]]):
        pulumi.set(self, "pod_selectors", value)

    @_builtins.property
    @pulumi.getter(name="removalDisabled")
    def removal_disabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Mark pods as removal disabled
        """
    ...
    def removal_disabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "removal_disabled", value)


class EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorArgsDict(TypedDict):
    match_expressions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorMatchExpressionArgsDict']]]]]
...
class EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorArgs:
    def __init__(__self__, *,
                 match_expressions: pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorMatchExpressionArgs']]]] = None,
    ...
    def match_expressions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorMatchExpressionArgs']]]]:
        return pulumi.get(self, "match_expressions")

    @match_expressions.setter
    def match_expressions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigNodeSelectorMatchExpressionArgs']]]]):
...
class EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorArgsDict(TypedDict):
    ...
    match_expressions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorMatchExpressionArgsDict']]]]]
    match_labels: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    namespace: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    replicas_min: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorArgs:
    def __init__(__self__, *,
                 ...
                 match_expressions: pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorMatchExpressionArgs']]]] = None,
                 match_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 namespace: pulumi.Input[Optional[_builtins.str]] = None,
                 replicas_min: pulumi.Input[Optional[_builtins.int]] = None):
        """
        :param pulumi.Input[_builtins.int] replicas_min: Minimum number of pod replicas to keep running when evicting matched pods
        """
        if kind is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="matchExpressions")
    def match_expressions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorMatchExpressionArgs']]]]:
        return pulumi.get(self, "match_expressions")

    @match_expressions.setter
    def match_expressions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EvictorAdvancedConfigEvictorAdvancedConfigPodSelectorMatchExpressionArgs']]]]):
        pulumi.set(self, "match_expressions", value)
    ...
    def replicas_min(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Minimum number of pod replicas to keep running when evicting matched pods
        """
    ...
    @replicas_min.setter
    def replicas_min(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "replicas_min", value)
