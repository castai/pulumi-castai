...
require (
	github.com/castai/terraform-provider-castai v0.24.3
...
replace github.com/castai/terraform-provider-castai => github.com/castai/terraform-provider-castai v0.24.3
